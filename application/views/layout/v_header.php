		...
		<header class="header-desktop3 d-none d-lg-block">
			<div class="section__content section__content--p35">
				<div class="header3-wrap">
					<a href="<?= base_url() ?>">
						<h3 style="color:aliceblue">GIS PELABUHAN TELUK BAYUR</h3>
					</a>
					...
					<div class="header__navbar">
						<ul class="list-unstyled">
							...
							<!-- <li>
								<a href="<?= base_url('home/wisata') ?>"><span class="bot-line"></span>List Lokasi</a>
							</li> -->
							<!-- <li>
					...
					<div class="header__tool">
						<div class="account-wrap">
							<div class="account-item account-item--style2 clearfix ">
								<a style="color:aliceblue" href="<?= base_url('auth/login') ?>"><i class="zmdi zmdi-key"></i> </a>
